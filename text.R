...
# Main Title
main_title = c("SARS-CoV-2")

description_text = c("Visualizing SARS-CoV-2 pandemic development data on log scale allows to see if lockdown efforts are  paying off. 
When plotted on log scale exponential growth appears as straight line going across the plot. 
